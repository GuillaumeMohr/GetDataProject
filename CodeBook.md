...
In this table, each line corresponds to one subject (whose id is in column 1) for one activity (which name is in 2). Columns 3 to 68 show the mean of the different variables for the subject and the activity of the line.


## Reference

This data has been obtained from the *Human Activity Recognition Using Smartphones Dataset, v1.0*. 
